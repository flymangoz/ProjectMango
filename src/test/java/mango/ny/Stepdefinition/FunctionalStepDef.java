...
import mango.ny.elementspage.MasterPageFactory;
import mango.ny.generic.CommonUtil;
...
public class FunctionalStepDef extends ParentClass {
	...
	public void users_able_to_click_on_products_module() {
		pf.getClickOnProductMod().click();
		CommonUtil.actionClick(pf.getClickOnProductMod());
